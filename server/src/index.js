...
// ============ تشغيل الخادم مع Socket.IO (WebRTC متكامل) ============
...
.then(async () => {
    ...
    global.rtcRooms = {};   // لتخزين أعضاء WebRTC لكل غرفة (مفتاح: roomId, قيمة: مصفوفة socket.id)
