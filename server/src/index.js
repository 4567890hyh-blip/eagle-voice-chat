...
// ============ النماذج المبسطة (مع الحقول الأساسية) ============
...
// --- Admin: أسعار الشحن والإحصائيات المتقدمة ---
...
// ============ تشغيل الخادم (بدون Socket.IO لإبقاء الأمور بسيطة) ============
...
.then(async () => {
    ...
    // Socket.IO بسيط (إذا أردت لاحقاً يمكنك إضافة أحداث الغرف)
